...
def write_tutor_data_to_csv():
    ...
    csv_file_path = r'C:\Users\ahmed\PycharmProjects\AOU Guide\data\aou_data\csv\Tutor.csv'
    ...
    with open(csv_file_path, mode='a', newline='', encoding='utf-8') as file:
        ...
        fieldnames = ["id", "name", "nameArabic", "title", "titleArabic", "email", "Biography", "BiographyArabic",
                      "office_hours", "specialization", "specializationArabic", "position", "positionArabic", "link"]
